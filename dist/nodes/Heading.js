...
class Heading extends Node_1.default {
    ...
    keys({ type }) {
        const options = this.options.levels.reduce((items, level) => (Object.assign(Object.assign({}, items), {
            [`Shift-Ctrl-${level}`]: (0, prosemirror_commands_1.setBlockType)(type, { level }),
        })), {});
        return Object.assign(Object.assign({}, options), { Backspace: (0, backspaceToParagraph_1.default)(type) });
    }
    get plugins() {
