...
class LinkEditor extends React.Component {
    constructor() {
        ...
        this.save = (href, title) => {
            ...
            if (!(0, isUrl_1.default)(href) && !href.startsWith("/") && !href.startsWith("#")) {
                href = `https://${href}`;
            }
    ...
    render() {
        ...
        return (React.createElement(Wrapper, null,
            React.createElement(Input_1.default, { value: value, placeholder: showCreateLink
                    ...
                    : dictionary.searchOrPasteLink, onKeyDown: this.handleKeyDown, onPaste: this.handlePaste, onChange: this.handleChange, autoFocus: this.href === "", type: "url", className: "link-editor-input" }),
            React.createElement(ToolbarButton_1.default, { onClick: this.handleOpenLink, disabled: !value },
                React.createElement(Tooltip, { tooltip: dictionary.openLink, placement: "top" },
                    React.createElement(outline_icons_1.OpenIcon, { color: theme.toolbarItem, className: "open-link-icon" }))),
